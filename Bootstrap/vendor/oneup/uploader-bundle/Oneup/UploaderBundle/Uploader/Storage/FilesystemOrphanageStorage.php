...
class FilesystemOrphanageStorage extends FilesystemStorage implements OrphanageStorageInterface
{
    ...
    public function uploadFiles(array $files = null,$id)
    {
            ...
            foreach ($files as $file) {
               ...
               $return[]= $this->storage->upload(new FilesystemFile(new File($file->getPathname())), str_replace($this->getFindPath(), '',$id.'/'.$file));
